...
goog.require('proto.person.Address');
...
proto.person.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    birthday: (f = msg.getBirthday()) && proto.my.date.Date.toObject(includeInstance, f),
 ...
 * @return {string}
 */
proto.person.Person.prototype.getSmallImage = function() {
 ...
 * @return {string}
 */
proto.person.Person.prototype.getSmallImage_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.person.Person.prototype.getSmallImage_asU8 = function() {
 ...
 * @return {!proto.person.Person} returns this
 */
proto.person.Person.prototype.setSmallImage = function(value) {
